...
static display_marquee_inform_event_callback_t event_callback = NULL;
...
static void set_inform_event_callback(display_marquee_inform_event_callback_t callback);
...
void display_init_interface(display_marquee_inform_event_callback_t callback){
