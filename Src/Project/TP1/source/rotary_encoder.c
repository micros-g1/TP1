...
typedef enum {RE_LL_LEFT,RE_LL_RIGHT,RE_LL_BUTTON_DOWN,RE_LL_BUTTON_UP,RE_LL_TIMEOUT,RE_LL_NO_EVENT,RE_LL_TOTAL_EVENTS} re_lowlevel_event_t;
...
static const re_lowlevel_event_t rotary_encoder_rotation_decode[2][2] =
...
static const re_lowlevel_event_t rotary_encoder_button_decode[2][2] =
{
...
{
	//Low Level Event
	re_lowlevel_event_t ev_ll = RE_LL_NO_EVENT;
